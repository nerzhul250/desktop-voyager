...
import src.detect_compo.lib_ip.ip_preprocessing as pre
import src.detect_compo.lib_ip.ip_draw as draw
import src.detect_compo.lib_ip.ip_detection as det
import src.detect_compo.lib_ip.file_utils as file
import src.detect_compo.lib_ip.Component as Compo
...
def compo_detection(input_img_path, output_root, uied_params,
                    resize_by_height=800,show=False, wai_key=0):
